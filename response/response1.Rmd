...
\begin{description}
\item[Reviewer 1:]\textcolor{violet}{please clarify. "If either the hourly wage or hours worked is missing, we do not tally this." I take "this" to mean "number_of_jobs". But in row 2, total_hours is missing, yet number_of_jobs is 1. The number of jobs (1) was tallied even though hours worked was missing.}
\end{description}

* We have clarified this that we only tally the number of jobs if the hourly wage is not missing.

\begin{description}
\item[Reviewer 1:]{"to find the anomaly in the wages values" This comes as a surprise to the reader. What anomaly? The wage anomalies should be mentioned in the introduction so as not to be a surprise at this point in the manuscript.}
\end{description}
