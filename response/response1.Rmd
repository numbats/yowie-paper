...
* **Need help** XXX We need to review this literature. It's not true that we have ignored it, the main reference is Dasu! But we need to decide whether there is more that we should cite. 
...
* We removed this sentence as we already have the `yr_wforce` variable which is calculated from the year of the individual start working. 
...
* We have filter the x-axis of the refreshed data set until 1994, so they are comparable.
